...
from todos.views import ShowTodoList, ShowTodoItem, create_todo_task, todo_list_update, delete_todo_list, create_todo_item, TodoItemUpdate
...
urlpatterns = [
    ...
    path("items/<int:id>/edit/", TodoItemUpdate, name="todo_item_update"),
]
